...
[Node.js](http://nodejs.org) के लिए तेज़, सरल और लचीला वेब फ्रेमवर्क।
...
यह एक [Node.js](https://nodejs.org/en/) मॉड्यूल है जो
[npm registry](https://www.npmjs.com/) के माध्यम से उपलब्ध है।

इंस्टॉल करने से पहले, [Node.js को डाउनलोड और इंस्टॉल करें](https://nodejs.org/en/download/)।
...
## विशेषताएं
- आपके कंट्रोलर्स और मॉडल्स से एक वैध OpenAPI (पूर्व में Swagger) स्पेक (2.0 या 3.0) स्वचालित रूप से जनरेट होता है, जिसमें शामिल हैं:
  - पाथ्स (जैसे GET /users)
  - joi स्कीमा के आधार पर परिभाषाएं
  - joi स्कीमा के आधार पर आवश्यक या वैकल्पिक के रूप में चिह्नित पैरामीटर/मॉडल प्रॉपर्टीज़ (जैसे joi.required() स्ट्रिंग OpenAPI स्पेक में आवश्यक है)
  - ऑब्जेक्ट विवरण के लिए jsDoc समर्थित (अधिकांश अन्य मेटाडेटा joi टाइप्स से निकाला जा सकता है)
- आपकी पसंद के मिडलवेयर के लिए रूट्स जनरेट होते हैं
...
- इंटर माइक्रोसर्विस कम्युनिकेशन
  - द्विदिशीय रिक्वेस्ट्स के लिए NATS.io का उपयोग किया जाता है
  - एकदिशीय मैसेज स्ट्रीमिंग के लिए KAFKA को सपोर्ट करता है
...
**Shekhar**
- Email: shekhar7x@gmail.com
- GitHub: [shekhar7x/base-helpers](https://github.com/shekhar7x/base-helpers.git)
