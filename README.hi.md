...
[Node.js](http://nodejs.org) के लिए तेज़, निष्पक्ष, मिनिमलिस्ट वेब फ्रेमवर्क।
...
Node.js 0.10 या उच्चतर संस्करण की आवश्यकता है।
...
अधिक जानकारी के लिए [हमारी इंस्टॉलेशन गाइड](http://expressjs.com/en/starter/installing.html) का अनुसरण करें।

## विशेषताएं

- आपके कंट्रोलर्स और मॉडल्स से एक वैध OpenAPI (पूर्व में Swagger) स्पेक (2.0 या 3.0 यदि आप चुनते हैं 😍) उत्पन्न होती है, जिसमें शामिल है:
...
- पसंद के मिडलवेयर के लिए रूट्स उत्पन्न होते हैं
  ...
  - रिक्वेस्ट पेलोड्स को मान्य करें
...
यह प्रोजेक्ट MIT लाइसेंस के तहत उपलब्ध है।
