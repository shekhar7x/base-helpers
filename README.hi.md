...
Node.js 0.10 या उससे अधिक संस्करण की आवश्यकता है।
...
अधिक जानकारी के लिए [हमारी इंस्टॉलेशन गाइड](http://expressjs.com/en/starter/installing.html) देखें।

## विशेषताएं
- आपके कंट्रोलर और मॉडल से एक वैध OpenAPI (पूर्व में Swagger) स्पेक (2.0 या 3.0 यदि आप चुनते हैं 😍) उत्पन्न होता है, जिसमें शामिल हैं:
  - पाथ (उदाहरण GET /users)
  - Joi schemas पर आधारित परिभाषाएं
  - Joi schemas के आधार पर आवश्यक या वैकल्पिक के रूप में चिह्नित पैरामीटर/मॉडल प्रॉपर्टी (उदाहरण joi.required() स्ट्रिंग OpenAPI स्पेक में आवश्यक है)
  - ऑब्जेक्ट विवरण के लिए jsDoc समर्थित (अधिकांश अन्य मेटाडेटा joi प्रकारों से अनुमानित किया जा सकता है)
- पसंद के middleware के लिए रूट उत्पन्न होते हैं
  - Express, Hapi, और Koa वर्तमान में समर्थित हैं, अन्य middleware को एक साधारण handlebars टेम्पलेट का उपयोग करके समर्थित किया जा सकता है
  - रिक्वेस्ट पेलोड को सत्यापित करें
- माइक्रोसर्विस के बीच संचार
  - द्विदिशात्मक रिक्वेस्ट के लिए NATS.io का उपयोग किया जाता है
