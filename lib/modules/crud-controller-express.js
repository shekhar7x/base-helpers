...
// Express controller wrapper for CRUD operations
class CrudContollerExpress {
    ...
    // Creates a new resource from request body
    ...
    async findById(request) {
        let { params: { id }, query: filter } = request;
        return this.module.aggregateById(id, filter);
    }
