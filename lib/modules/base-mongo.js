...
// Base class for MongoDB CRUD operations with aggregation support
class BaseMongo {
    ...
    // Modifies document by fetching and saving (triggers Mongoose middleware)
    ...
    // Updates document using findByIdAndUpdate (bypasses Mongoose middleware)
    ...
    // Deletes document (hard delete) or marks as deleted (soft delete)
