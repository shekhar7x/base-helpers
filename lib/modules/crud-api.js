...
// API configuration builder for CRUD operations
class CrudApi {
    constructor(
        controller,
    ...
    // Generates API config for creating a resource
    ...
    // Generates API config for retrieving all resources
    ...
    // Generates API config for retrieving a resource by ID
    ...
    // Generates API config for partial update (PATCH)
