...
const routeToSwagger = require('../swagger/route-to-swagger');
const errorUtils = require('./error-utils');
const Joi = require('joi');
const Mongoose = require('mongoose');
const config = require("../../config");
let baseSwaggerSpec = config.get('/documentation/baseswaggerspec');
let routeUtils = {};
...
let createSwaggerUIForRoutes = (app, routes = []) => {
    let swaggerSpec = routeToSwagger.swaggerDoc.createJsonDoc(baseSwaggerSpec);
    routes.forEach(route => {
